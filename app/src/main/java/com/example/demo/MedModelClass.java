...
public class MedModelClass {
    private String id,medname, startdate, enddate, days,time,userid;
    public MedModelClass(){
    }

    public MedModelClass(String id,String medname, String startdate, String enddate, String days,String time,String userid) {
        this.id=id;
